...
mvn -DskipTests install package > out.err 2> out2.err
rem mvn -pl :spark-core_2.11 -DskipTests package > out.err 2> out2.err
rem mvn -e -X  -DskipTests -pl :spark-datalog_2.11 package > out.err 2> out2.err
rem mvn -pl :spark-datalog_2.11 package > out.err
